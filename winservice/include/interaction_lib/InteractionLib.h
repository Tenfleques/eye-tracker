...
namespace IL
{
    ...
    /// CreateInteractionLib() or CreateInteractionLib(IL_AdapterFunctions*), an actual Interaction Library 
    ...
    IL_API InteractionLib* CreateInteractionLib(FieldOfUse fieldOfUse, IL_AdapterFunctions* adapterFunctions);
    ...
    public:
        ...
        ///                           
        ///                           However, it is still possible to add interactors and subscribe to gaze focus events and data streams.
        virtual void SetAdapter(IL_AdapterFunctions* adapterFunctions) = 0;
        ...
        virtual void SubscribeGazeFocusEvents(GazeFocusEventCallback callback, void* context) = 0;
