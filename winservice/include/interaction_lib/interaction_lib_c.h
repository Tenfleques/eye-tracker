...
#include "interaction_lib/datatypes/InteractionEventTypes.h"
#include "interaction_lib/datatypes/UnfilteredGazePointData.h"
...
///                                @c NULL is a valid parameter value, with the meaning that the following InteractionLib functions
...
/// @param[out]  context           Pointer to an IL_Context structure used internally to identify an actual underlying Interaction Library implementation.
/// @return                        IL_Result_Ok If successful; otherwise another IL_Result warning or error code.
IL_C_API IL_Result IL_CreateInteractionLibWithAdapter(IL_Context** context, IL_FieldOfUse fieldOfUse, IL_AdapterFunctions* adapterFunctions);
