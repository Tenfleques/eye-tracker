...
#include "../datatypes/UnfilteredGazePointData.h"
...
typedef void(*ILAdapter_PostUnfilteredGazePointDataCallback)   (const IL_UnfilteredGazePointData*, void* context);
...
typedef bool(*ILAdapter_RegisterPostUnfilteredGazePointDataCallback)(ILAdapter_AdapterContext, ILAdapter_PostUnfilteredGazePointDataCallback, void* context);
...
typedef struct IL_AdapterFunctions
{
    ...
    ILAdapter_RegisterPostUnfilteredGazePointDataCallback registerPostUnfilteredGazePointDataCallback;
