...
#include "UnfilteredGazePointData.h"
...
typedef void(*IL_UnfilteredGazePointDataCallback)(IL_UnfilteredGazePointData, void*);
...
namespace IL
{
    ...
    using UnfilteredGazePointDataCallback = StreamingDataCallback<UnfilteredGazePointData>;
